...
namespace DAO
{
    ...
    partial void InsertTangLau(TangLau instance);
    partial void UpdateTangLau(TangLau instance);
    partial void DeleteTangLau(TangLau instance);
    ...
    partial void Deletehethong(hethong instance);
		...
		public HotelDataContext() : 
				base(global::DAO.Properties.Settings.Default.qlks3lopConnectionString2, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<TangLau> TangLaus
		{
			get
			{
				return this.GetTable<TangLau>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TangLau")]
	public partial class TangLau : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnMaTangLauChanging(int value);
    partial void OnMaTangLauChanged();
    partial void OnTenTangLauChanging(string value);
    partial void OnTenTangLauChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaTangLau", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int MaTangLau
		{
			get
			{
				return this._MaTangLau;
			}
			set
			{
				if ((this._MaTangLau != value))
				{
					this.OnMaTangLauChanging(value);
					this.SendPropertyChanging();
					this._MaTangLau = value;
					this.SendPropertyChanged("MaTangLau");
					this.OnMaTangLauChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TenTangLau", DbType="NVarChar(MAX)")]
		public string TenTangLau
		{
			get
			{
				return this._TenTangLau;
			}
			set
			{
				if ((this._TenTangLau != value))
				{
					this.OnTenTangLauChanging(value);
					this.SendPropertyChanging();
					this._TenTangLau = value;
					this.SendPropertyChanged("TenTangLau");
					this.OnTenTangLauChanged();
				}
			}
		}
